...
class AmFootballHeaderView: UITableViewCell {
    ...
    private func addViews() {
        [indexLabel, teamLabel, matchesLabel, winsLabel, drawsLabel, lossesLabel, percentageLabel].forEach {
